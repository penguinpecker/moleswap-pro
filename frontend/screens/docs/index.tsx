      ...
      <header className="docs-topbar">
        <div className="docs-topbar-inner">
          ...
          <div className="docs-topbar-right">
            <a href="https://github.com/penguinpecker/moleswap-pro" target="_blank" rel="noopener noreferrer" className="docs-github-link">
          ...
          <footer className="docs-footer">
            <div className="docs-footer-inner">
              ...
              <div className="docs-footer-links">
                <a href="https://github.com/penguinpecker/moleswap-pro" target="_blank" rel="noopener noreferrer">GitHub</a>
                <a href="/" >App</a>
