      ...
      <div className="relative z-20 mx-auto w-full max-w-5xl flex-1 px-1 sm:px-2 md:p-6">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative z-10 space-y-6 px-6 pt-16 pb-10 sm:px-10">
            ...
            <h2 className="text-peach-300 text-shadow-header font-family-ThaleahFat text-center text-xl tracking-wider uppercase sm:text-3xl">The Underground DEX Built on Push Chain</h2>
